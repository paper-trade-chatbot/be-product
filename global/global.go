...
import "github.com/paper-trade-chatbot/be-product/config"
...
const ServerEnvProd = "prod"
const ServerEnvStressTest = "stress-test"
const ServerEnvPaperTrade = "paper-trading"
