module github.com/paper-trade-chatbot/be-product
...
require (
	...
	github.com/paper-trade-chatbot/be-common v0.0.0-20230109084830-e4ae3fd01d4a
	github.com/paper-trade-chatbot/be-proto v0.0.0-20221205073319-5884a27006a5
